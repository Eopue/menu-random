...
public interface DishesMapper {
     ...
     * 根据条件更新属性不为空的记录
     */
    int updateByParamsSelective(@Param("record") Dishes record, @Param("condition") Map<String, Object> condition);

    /**
     * 根据条件更新记录
     */
    int updateByParams(@Param("record") Dishes record, @Param("condition") Map<String, Object> condition);
